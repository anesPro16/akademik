            ...
            const optionsHtml = ['A', 'B', 'C', 'D'].map(opt => `
                <div class="col-md-6 mb-2">
                    <div class="form-check p-0">
                        <input class="form-check-input d-none" type="radio" name="answers[${q.id}]" id="q${q.id}_${opt}" value="${opt}">
                        <label class="form-check-label w-100 p-3 border option-hover d-flex align-items-center" for="q${q.id}_${opt}">
