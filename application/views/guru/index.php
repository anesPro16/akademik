            ...
            <?php foreach ($kelas_list as $kelas): ?>
                <div class="col-lg-6 col-xl-4 mb-4">
                    ...
                    <div class="card shadow h-100 py-2 border-left-success">
                        ...
                        <!-- Footer hanya berisi tombol Detail -->
                        <div class="card-footer bg-white d-flex justify-content-end align-items-center">
                            <a href="<?= base_url('guru/dashboard/class_detail/' . $kelas->id) ?>" class="btn btn-sm btn-success shadow-sm">
                                Lihat Detail & Murid <i class="fas fa-arrow-right ml-1"></i>
                            </a>
                        </div>
                    </div>
