            ...
            <div class="row">
                <div class="col-lg-8">
                    <h5 class="fw-bold text-dark mb-2">
                        <i class="bi bi-journal-text me-2 text-primary"></i>Instruksi Esai Utama
                    </h5>
                    <div class="text-muted fs-6">
                        <?= nl2br(htmlspecialchars($essay->description, ENT_QUOTES, 'UTF-8')); ?>
                    </div>
                </div>
                <div class="col-lg-4 text-lg-end mt-3 mt-lg-0 border-start-lg">
                    <a href="<?= base_url('guru/pbl/tahap4/' . $class_id) ?>" class="btn btn-outline-secondary">
                        <i class="bi bi-arrow-left me-1"></i> Kembali ke Tahap 4
                    </a>
                </div>
            </div>
        </div>
