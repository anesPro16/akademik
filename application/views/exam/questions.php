		...
		<div class="modal-content">
			<form id="bulkForm">
				...
				<div class="modal-header bg-primary text-white">
					<h5 class="modal-title">Buat Soal Sekaligus</h5>
				...
				<div class="modal-body bg-light">
					...
					<div class="d-grid gap-2 mt-3">
						<button type="button" class="btn btn-outline-primary border-dashed" id="btnAddRow">
							<i class="bi bi-plus-circle"></i> Tambah Baris Soal Baru
						</button>
					</div>
				</div>
...
<template id="questionRowTemplate">
	<div class="card mb-3 question-row shadow-sm border-0">
		<div class="card-header d-flex justify-content-between align-items-center bg-white">
			<span class="fw-bold text-primary">Soal #<span class="row-number"></span></span>
			<button type="button" class="btn btn-sm btn-danger btn-remove-row"><i class="bi bi-trash"></i> Hapus</button>
		</div>
		<div class="card-body">
			<div class="mb-3">
				<textarea name="question[]" class="form-control" rows="2" placeholder="Tulis pertanyaan..." required></textarea>
			</div>
			<div class="row g-2">
				<div class="col-md-6">
			...
			<div class="mt-3 row align-items-center">
				<label class="col-auto col-form-label fw-bold">Kunci Jawaban:</label>
				<div class="col-auto">
					<select name="correct_answer[]" class="form-select form-select-sm bg-success text-white" required>
                ...
                <div class="modal-body">
                    ...
                    <div class="row g-2 mb-3">
                        <div class="col-6">
                            ...
                            <input type="text" name="option_a" id="edit_option_a" class="form-control form-control-sm" required>
                        </div>
                        <div class="col-6">
                            <label class="form-label small">Opsi B</label>
                            <input type="text" name="option_b" id="edit_option_b" class="form-control form-control-sm" required>
                        </div>
                        <div class="col-6">
                            <label class="form-label small">Opsi C</label>
                            <input type="text" name="option_c" id="edit_option_c" class="form-control form-control-sm" required>
                        </div>
                        <div class="col-6">
                            <label class="form-label small">Opsi D</label>
                            <input type="text" name="option_d" id="edit_option_d" class="form-control form-control-sm" required>
                        </div>
                    </div>
