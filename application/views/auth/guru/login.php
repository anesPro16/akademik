        ...
        <div class="card shadow-lg border-0 rounded-4">
          <div class="card-body p-4 p-sm-5">
            ...
            <div class="text-center mb-4">
              ...
              <h3 class="fw-bold">Selamat Datang Guru 👋</h3>
              <p class="text-muted"> Ayo Lanjutkan perjalanan mengajarmu hari ini.</p>
            </div>
            ...
            <form action="<?= site_url('guru/auth'); ?>" method="POST">
              <div class="mb-3">
            ...
            <div class="text-center mt-4">
              <p class="text-muted">Belum punya akun? <a href="<?= site_url('guru/auth/register'); ?>" class="fw-bold text-decoration-none">Daftar sekarang</a></p>
            </div>
          </div>
        </div>
      </div>
