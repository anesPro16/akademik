...
class Pbl_tahap3_model extends CI_Model {

	// Definisikan tabel untuk Tahap 3
	private $table_observations = 'pbl_observation_slots';
  ...
  {
  	return $this->db->where('id', $id)->get($this->table_observations)->row();
  }
	...
	{
		return $this->db->where('id', $id)->update($this->table_observations, $data);
	}

	public function delete_observation($id)
	{
		return $this->db->where('id', $id)->delete($this->table_observations);
	}
...
/* End of file Pbl_tahap3_model.php */
/* Location: ./application/models/Pbl_tahap3_model.php */